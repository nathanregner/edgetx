...
#define TR_BL_CURRENT_FW               "Current firmware:"
  ...
  #define TR_BL_DISABLE                "Deaktiver"
    ...
    #define TR_BL_FLASH_KEY            "Hold [SW1A] længe, for at starte"
    ...
    #define TR_BL_FLASH_KEY            "Hold [TR4 Dn] længe, for at starte"
  ...
  #define TR_BL_FLASH_KEY              "Hold [ENT] længe, for at starte"
  #define TR_BL_ERASE_KEY              "Hold [ENT] længe, for sletning"
